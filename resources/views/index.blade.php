...
<body>
    <nav class="navbar navbar-expand-lg bg-blue border-bottom border-bottom-dark sticky-top bg-body-tertiary"
        data-bs-theme="dark">
        <div class="container">
        <a class="navbar-brand fw-light" href="/"><span class="fas fa-dove me-1"> </span>{{ config('app.name') }}</a>
